...
print("Reading values from inf_output_old.json")
with open('inf_output.json', 'r') as file:
    inf_output = json.load(file)
...
cosmosdb_key_old = client_new.get_secret('COSMOSDB-KEY')
# *************************************************************************
...
client = CosmosClient(cosmosdb_url_old, credential=cosmosdb_key_old)
